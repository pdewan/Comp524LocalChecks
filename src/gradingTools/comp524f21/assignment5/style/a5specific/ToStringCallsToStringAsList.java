...
@MaxValue(1)
@IsExtra(true)
public class ToStringCallsToStringAsList extends CheckstyleMethodCalledTestCase{
	@Override
...
//	main.lisp.parser.terms.TAtomicExpressionFactory!newInstance:->.*,
	...
	public ToStringCallsToStringAsList() {
		super("Not", "main.lisp.parser.terms.NilAtomicExpressionFactory!newInstance:->.*");
	}
