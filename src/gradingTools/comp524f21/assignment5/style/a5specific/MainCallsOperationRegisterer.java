...
@MaxValue(2)
//@IsExtra(true)
public class MainCallsOperationRegisterer extends CheckstyleMethodCalledTestCase{
	@Override
	...
	public MainCallsOperationRegisterer() {
		super("Main", "@CustomOperationRegisterer!registerAll:->void");
	}
