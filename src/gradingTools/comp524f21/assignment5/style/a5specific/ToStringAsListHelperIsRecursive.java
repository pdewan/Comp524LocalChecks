...
@MaxValue(2)
//@IsExtra(true)
public class ToStringAsListHelperIsRecursive extends CheckstyleMethodCalledTestCase{
	@Override
	...
	public ToStringAsListHelperIsRecursive() {
		super("Method:toStringAsListHelperPublic:->String", "toStringAsListHelperPublic:->String");
	}
