...
@MaxValue(1)
@IsExtra(true)
public class LoadCallsNilAtomFactory extends CheckstyleMethodCalledTestCase{
	@Override
...
//	main.lisp.parser.terms.TAtomicExpressionFactory!newInstance:->.*,
	...
	public LoadCallsNilAtomFactory() {
		super("Load", "main.lisp.parser.terms.NilAtomicExpressionFactory!newInstance:->.*");
	}
