...
@MaxValue(1)
@IsExtra(true)
public class LTECallsTAtomFactory extends CheckstyleMethodCalledTestCase{
	@Override
...
//	main.lisp.parser.terms.TAtomicExpressionFactory!newInstance:->.*,
	...
	public LTECallsTAtomFactory() {
		super("LTE", "main.lisp.parser.terms.TAtomicExpressionFactory!newInstance:->.*");
	}
