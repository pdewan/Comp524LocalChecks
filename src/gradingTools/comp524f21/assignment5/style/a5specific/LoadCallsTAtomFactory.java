...
@MaxValue(1)
@IsExtra(true)
public class LoadCallsTAtomFactory extends CheckstyleMethodCalledTestCase{
	@Override
...
//	main.lisp.parser.terms.TAtomicExpressionFactory!newInstance:->.*,
	...
	public LoadCallsTAtomFactory() {
		super("Load", "main.lisp.parser.terms.TAtomicExpressionFactory!newInstance:->.*");
	}
