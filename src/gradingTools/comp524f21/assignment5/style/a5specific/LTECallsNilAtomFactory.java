...
@MaxValue(1)
@IsExtra(true)
public class LTECallsNilAtomFactory extends CheckstyleMethodCalledTestCase{
	@Override
...
//	main.lisp.parser.terms.TAtomicExpressionFactory!newInstance:->.*,
	...
	public LTECallsNilAtomFactory() {
		super("LTE", "main.lisp.parser.terms.NilAtomicExpressionFactory!newInstance:->.*");
	}
