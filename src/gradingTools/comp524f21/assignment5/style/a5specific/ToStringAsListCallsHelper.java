...
@MaxValue(2)
//@IsExtra(true)
public class ToStringAsListCallsHelper extends CheckstyleMethodCalledTestCase{
	@Override
	...
	public ToStringAsListCallsHelper() {
		super("Method:toStringAsList", "toStringAsListHelperPublic:->String");
	}
