...
@MaxValue(2)
public class DerivingModelRegistersObserver extends CheckstyleMethodDefinedTestCase{
	...
	public DerivingModelRegistersObserver() {
		super("SocialDistanceBasicModel", "addPropertyChangeListener:java.beans.PropertyChangeListener->void ");
