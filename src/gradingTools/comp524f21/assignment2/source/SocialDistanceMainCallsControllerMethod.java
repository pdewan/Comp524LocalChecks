...
@MaxValue(3)
public class SocialDistanceMainCallsControllerMethod extends CheckstyleMethodCalledTestCase {
...
//	[WARN] D:\dewan_backup\Java\grail13\.\src\greeting\Cls.java:6: Missing signature main:String[]->void in type greeting.Cls:[@Comp301Tags.GREETING_MAIN]. [ExpectedSignatures]
	...
	public SocialDistanceMainCallsControllerMethod() {
...
//		super("@SocialDistanceController", "@SocialDistanceModelFactory!getSingleton:->\\.\\*");
		super("@SocialDistanceMVCInterpolatingMain", "@SocialDistanceController!\\.\\*:\\*->\\.\\*");
