...
@MaxValue(3)
public class SocialDistanceControllerFetchesModelSingleton extends CheckstyleMethodCalledTestCase {
...
//	[WARN] D:\dewan_backup\Java\grail13\.\src\greeting\Cls.java:6: Missing signature main:String[]->void in type greeting.Cls:[@Comp301Tags.GREETING_MAIN]. [ExpectedSignatures]
	...
	public SocialDistanceControllerFetchesModelSingleton() {
...
//		super("@SocialDistanceController", "@SocialDistanceModelFactory!getSingleton:->\\.\\*");
		super("@SocialDistanceController", "@SocialDistanceModelFactory!getSingleton:->@SocialDistanceInterpolatingModel");
