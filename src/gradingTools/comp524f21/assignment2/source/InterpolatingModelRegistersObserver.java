...
@MaxValue(2)
public class InterpolatingModelRegistersObserver extends CheckstyleMethodDefinedTestCase{
	...
	public InterpolatingModelRegistersObserver() {
		super("SocialDistanceInterpolatingModel", "addPropertyChangeListener:java.beans.PropertyChangeListener->void ");
