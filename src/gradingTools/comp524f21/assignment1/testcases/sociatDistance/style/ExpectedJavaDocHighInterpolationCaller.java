...
@MaxValue(5)
public class ExpectedJavaDocHighInterpolationCaller extends CheckstyleMethodHasJavaDocTestCase {
...
//	[WARN] D:\dewan_backup\Java\grail13\.\src\greeting\Cls.java:6: Missing signature main:String[]->void in type greeting.Cls:[@Comp301Tags.GREETING_MAIN]. [ExpectedSignatures]
	...
	public ExpectedJavaDocHighInterpolationCaller() {
		super("@BasicSocialDistanceUtility", "then it is interpolated high");
