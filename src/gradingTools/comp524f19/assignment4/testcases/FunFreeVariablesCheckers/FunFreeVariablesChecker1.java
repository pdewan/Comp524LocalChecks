...
@MaxValue(30)
@IsExtra(true)
public class FunFreeVariablesChecker1 extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall FreeVariableBindingTester 13 7 100)"};
