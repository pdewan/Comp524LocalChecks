...
@MaxValue(30)
@IsExtra(true)
public class CurryableTraverseChecker2 extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(curryableTraverse l-write-to-string dotcat  (list 2 (cons 4 5)))"};
