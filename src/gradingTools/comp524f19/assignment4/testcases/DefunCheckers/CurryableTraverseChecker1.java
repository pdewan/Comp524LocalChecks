...
@MaxValue(30)
@IsExtra(true)
public class CurryableTraverseChecker1 extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(curryableTraverse one sum (list 2 (cons 4 5)))"};
