...
@MaxValue(10)
public class FunExpGeneratedToStringChecker extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall funExpGeneratedToStringAsSexpression (list 2 (cons 4 5)))"};
