...
@MaxValue(10)
public class GeneratedNumAtomChecker extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall generatedNumAtoms (list 2 (cons 4 5)))"};
