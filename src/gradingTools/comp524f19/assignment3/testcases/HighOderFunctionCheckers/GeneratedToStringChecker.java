...
@MaxValue(10)
public class GeneratedToStringChecker extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall generatedToStringAsSExpression (list 2 (cons 4 5)))"};
