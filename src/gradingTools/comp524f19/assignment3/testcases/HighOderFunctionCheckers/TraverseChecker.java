...
@MaxValue(50)
public class TraverseChecker extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall traverse (list 2 (cons 4 5)) l-write-to-string dotcat)"};
