...
@MaxValue(10)
public class FunArgToStringGenChecker extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall (funcall funArgToStringAsSExpressionGenerator) (list 2 (cons 4 5)))"};
