...
@MaxValue(25)
@IsExtra(true)
public class LetGeneratedNumAtomChecker extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall letGeneratedNumAtoms (list 2 (cons 4 5)))"};
