...
@MaxValue(25)
@IsExtra(true)
public class LetGeneratedToStringChecker extends AbstractLispExpressionResultChecker {
	public static final String[] STUDENT_INPUT = {"(funcall letGeneratedToStringAsSexpression (list 2 (cons 4 5)))"};
