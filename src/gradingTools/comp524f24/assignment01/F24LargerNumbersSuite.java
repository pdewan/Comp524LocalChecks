...
import gradingTools.shared.testcases.concurrency.oddNumbers.SynchronizationLargerProblemInRepository;
...
@Suite.SuiteClasses({	
	...
	SynchronizationLargerProblemInRepository.class
...
//@MaxValue(50)
public class F24LargerNumbersSuite {
...
//			BasicExecutionSpecificationSelector.getBasicExecutionSpecification().setLanguage(BasicLanguageDependencyManager.JAVA_LANGUAGE);
			...
			BasicJUnitUtils.interactiveTest(F24LargerNumbersSuite.class);
