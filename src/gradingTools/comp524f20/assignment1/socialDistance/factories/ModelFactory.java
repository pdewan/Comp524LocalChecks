...
public class ModelFactory extends FactoryMethodTest {
	...
	protected Class proxyClass() {
		return TestModelInterface.class;
	}
	@Override
	...
	protected Class factoryClass() {
		...
		Class retVal = aTestMapReduceConfiguration.getSocialDistanceModelFactory();
		if (retVal == null) {
			assertTrue("Null model factory in class registry", false);
		}
		return retVal;
	}
	@Override
