...
//@MaxValue(2)
public class SocialDistanceInferringMainProvided extends PassFailJUnitTestCase {
...
//			sExpressionClass = (Class<? extends SExpression>) callGetterOnClassRegistry(aMethodName);
			socialDistanceMain = aClassRegistry.getSocialDistanceMVCInferringMain();   
		    if (socialDistanceMain == null) {	
		    	return fail ("getSocialDistanceMVCInferringMain returns null in class registry");
		    }	
