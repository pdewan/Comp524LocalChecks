...
//@MaxValue(2)
public class SocialDistanceDerivingMainProvided extends PassFailJUnitTestCase {
...
//			sExpressionClass = (Class<? extends SExpression>) callGetterOnClassRegistry(aMethodName);
			socialDistanceMain = aClassRegistry.getSocialDistanceMVCDerivingMain();   
		    if (socialDistanceMain == null) {	
		    	return fail ("getSocialDistanceMVCDerivingMain returns null in class registry");
		    }	
