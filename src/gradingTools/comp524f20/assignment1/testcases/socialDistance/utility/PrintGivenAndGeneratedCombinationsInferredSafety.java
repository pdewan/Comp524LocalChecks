...
@MaxValue(7)
public class PrintGivenAndGeneratedCombinationsInferredSafety extends AbstractPrintDerivedSafetyValidator {
	...
	public PrintGivenAndGeneratedCombinationsInferredSafety() {
	}
	@Override
