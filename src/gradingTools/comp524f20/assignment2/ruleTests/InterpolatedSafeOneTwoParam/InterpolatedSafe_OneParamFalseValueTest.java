...
@MaxValue(2)
public class InterpolatedSafe_OneParamFalseValueTest extends AnAbstractPrologRunningProject {
	public static final int TIME_OUT_SECS = 1; // secs	

	public InterpolatedSafe_OneParamFalseValueTest() {
	}
...
//			LinesMatcher aLinesMatcher = aRunningProject.getLinesMatcher();
			String [] releventInputs=Arrays.copyOfRange(outputGeneration.getInputs(), 31,  outputGeneration.getInputs().length);
