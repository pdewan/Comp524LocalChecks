...
@MaxValue(6)
public class GivenSafe_TableTest extends AnAbstractPrologRunningProject {
	public static final int TIME_OUT_SECS = 1; // secs	

	public GivenSafe_TableTest() {
	}
	...
	public TestCaseResult test(Project project, boolean autoGrade) throws NotAutomatableException,
		...
		try {
			...
			GivenSafe_OutputGeneration outputGeneration = (GivenSafe_OutputGeneration) JUnitTestsEnvironment.getAndPossiblyRunGradableJUnitTest(GivenSafe_OutputGeneration.class);			
