...
@MaxValue(10)
public class CurryableMatchingSafe extends AnAbstractThreeParameterSMLRunningProject {
	public static final int TIME_OUT_SECS = 1; // secs	

	public CurryableMatchingSafe() {
	}
	
	private final String functionName="curryableMatchingSafe";
	private final String testFunctionName="curriedTestCall";
	...
	protected String [] generateFunctionCalls(String functionName) {
		...
		retVal[1]="val "+testFunctionName+" = "+ functionName +" "+testMatcherName+";";
