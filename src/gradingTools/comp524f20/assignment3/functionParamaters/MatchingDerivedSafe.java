...
@MaxValue(10)
public class MatchingDerivedSafe extends AnAbstractThreeParameterSMLRunningProject {
	public static final int TIME_OUT_SECS = 1; // secs	

	public MatchingDerivedSafe() {
	}
	
	private String functionName="matchingDerivedSafe";
